...
export class InformeService {
  ...
  getInformesS(n: number): Observable<Object[]> {
    return this.http.get<Object[]>(`${this.urlInforme}/sem/${n}`, { headers: this.httpHeaders });
  }
  getInformeC(n: number): Observable<Object[]> {
    return this.http.get<Object[]>(`${this.urlInforme}/cic/${n}`, { headers: this.httpHeaders })
  }
